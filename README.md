## REST API - Node.js Express with PostgreSQL DB
...
- **ECR_ENDPOINT**: The name of the Amazon ECR repository to publish to. This variable takes the format: _<accountnumber>_.dkr.ecr._<aws-region>_.amazonaws.com
